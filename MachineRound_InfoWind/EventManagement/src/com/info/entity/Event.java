...
public class Event {
	...
	public Event(String title, LocalDate date, LocalTime startTime, LocalTime endTime, String description) {
		...
		if(!startTime.isBefore(endTime))
			throw new InvalidEventException("End time could not before start time");
	}
	...
	public String toString() {
		return "Event [title=" + title + ", date=" + date + ", startTime=" + startTime + ", endTime=" + endTime + ", description=" + description + "]"; 
	}
